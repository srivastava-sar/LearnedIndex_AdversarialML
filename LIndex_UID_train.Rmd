...
```{r readData}
DIGIX <- read.csv(file = "datasets/train_data-uid.csv")
str(DIGIX)
attach(DIGIX)
```
...
<<Polyfit_Visual>>
Quadfunct = func_PolyVis(X,5,uid,DIGIX)
```
...
maxQ <- which(Quadfunct$residuals^2>23000)
#Max k residuals
#print(maxQ)
#print(maxQ)
print(length(maxQ))
...
outcomeExits = func_CUSUM2(FIT,4,keyDiff,keyDim,y_lim=5)
#print(outcomeExits)
<<PlotRes>>
...
outcomeExits = func_CUSUM_wrapper(FIT,6,keyDiff,keyDim,y_lim=50)
